...
function getMainLanguage(record) {
  ...
  const languagesObj = getRecordLanguageStats(record)
...
function getRecordLanguageStats(dbRecord) {
  const languageData = dbRecord.languageData[languageDetectionEngine]
